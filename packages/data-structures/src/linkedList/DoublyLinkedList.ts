import { IDoublyLinkedList, IDoublyLinkedListNode } from "./interface";

class Node<T> implements IDoublyLinkedListNode<T> {
  value: T;
  prev: Node<T> | null;
  next: Node<T> | null;
...
export class DoublyLinkedList<T> implements IDoublyLinkedList<T>, Iterable<T> {
